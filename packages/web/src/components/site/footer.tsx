      ...
      <span className="inline-flex items-center gap-1.5 rounded-lg border border-gray-200 bg-white px-4 py-2 text-sm font-medium text-gray-600 shadow-sm transition-all hover:border-blue-300 hover:text-blue-600 hover:shadow-md hover:-translate-y-0.5 cursor-pointer">
        ...
        >
          <path
            ...
            strokeWidth={2}
            d="M12 4v1m6 11h2m-6 0h-2m0 0H8m4-11a1 1 0 011 1v.5a1 1 0 01-1 1h-1a1 1 0 01-1-1V6a1 1 0 011-1h1zm-6 5a1 1 0 011-1h8a1 1 0 011 1v7a1 1 0 01-1 1H7a1 1 0 01-1-1v-7z"
          />
        </svg>
      </span>
      {/* Popup */}
            ...
            {(hasSocial || hasQr) && (
              <div>
                ...
                <div className="flex flex-wrap gap-3">
                  ...
                  {/* QR code buttons */}
                  {hasQr &&
                    Object.entries(qrCodes!).map(([name, imgUrl]) => (
